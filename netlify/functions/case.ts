...
import { ALL_AGENT_ROLES, getModelForRole } from './lib/models';
...
//
// Also returns the real model configured per role, so the frontend can show
// which model is actually in play without hardcoding a copy of models.ts
// that could silently drift out of sync - this is itself just a config
// read, no OpenRouter call involved.
